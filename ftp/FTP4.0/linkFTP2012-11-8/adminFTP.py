...
if __name__=='__main__':
    ...
    if len(sys.argv)!=4:
        ...
        #print "连接成功"
            ...
            print u"IP:",sys.argv[1].strip(),u"用户名:",sys.argv[2].strip(),u"密码:",sys.argv[3].strip(),u"连接成功"
        else:
            #print "连接失败"
            print sys.argv[1].strip(),u"扫描完成===FTP状态：",ftpID
            print u"IP:",sys.argv[1].strip(),u"用户名:",sys.argv[2].strip(),u"密码:",sys.argv[3].strip(),u"连接失败"
