...
setup(version = "1.0",description = "QQ:2602159946",name = "FTP",zipfile=None,windows=[{"script": "window-1.py", "icon_resources": [(1, "App.ico")]}],options={"py2exe":{"dll_excludes":["MSVCP90.dll"],"includes":["sip"]}},includes = ["Cmysql.py"])
