...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(810, 10, 471, 511))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.textEdit_2 = QtGui.QTextEdit(self.groupBox_2)
        self.textEdit_2.setGeometry(QtCore.QRect(10, 20, 451, 481))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1289, 23))
...
#                    self.model.setItem(i, 5, QStandardItem(data5))
    ...
    #########################
        ...
        self.model.setColumnCount(5)     #列
        self.model.setRowCount(self.led+3)  #行  len(node)
        self.model.setHorizontalHeaderLabels([u'IP(域名)',u'用户名',u'密码',u'root权限',u'time时间'])
