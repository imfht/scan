...
setup(version = "1.2",description = "QQ:2602159946",
    name = "postadmin",zipfile=None,
    console=[{"script": "main.py", "icon_resources": [(1,"123.ico")]}],
    options={"py2exe":{"includes":["sip"]}},
    includes1 = ["Cmysql.py","Cftp.py","CpasswordFTP.py","wwwIP_baiduQZ_PR.py","internet_close.dll"])
