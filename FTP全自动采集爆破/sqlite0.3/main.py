...
if __name__=='__main__':
    print "---------------------------------------------------------------------"
    print "      欢迎使用FTP--webshell权限查找器sqlite--0.2-----BY：落雪            "
    print "      谢谢灰帽程序员论坛对本软件技术支持--http://hmhacker.org/            "
    print "  落雪网络技术--QQ交流群293663651---请勿作违法之用本软件只是测试网络安全性   "
    print "----------------------------------------------------------------------"
    #time.sleep(10)
    try:
        if Aintet_close():
